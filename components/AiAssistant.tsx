    ...
    {!standalone && <section className="mx-auto mt-8 max-w-5xl border-y border-white/[0.07] py-6">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-xs text-white/30">Gratis: 1 análisis semanal · 5 mensajes diarios. <Link href="/precios" className="text-emerald-200/60 hover:text-emerald-100">Ver Pro</Link></p>
        </div>
