      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-10 rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm leading-relaxed text-zinc-400">
            <li>
              • Total invertido real = monto inicial + costos extra.
            </li>
            <li>
              • Ganancia nominal = monto final − total invertido real.
            </li>
            <li>
            ...
            <li>
              • Si el rendimiento real es positivo, ganaste poder de compra.
            </li>
            <li>
              • Si el rendimiento real es negativo, perdiste poder de compra.
            </li>
          </ul>
        </section>
        ...
        <section className="mt-6 rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm leading-relaxed text-zinc-400">
            ...
            <li>
              • No contempla impuestos o costos que no hayan sido cargados.
            </li>
            <li>
            ...
            <li>
              • Los resultados son una simulación, no asesoramiento financiero.
            </li>
          </ul>
        </section>
        ...
        <section className="mt-10 space-y-8 rounded-3xl border border-zinc-800 bg-zinc-950 p-6 leading-relaxed text-zinc-400">
          ...
          <SeoSection title="Errores comunes">
            <ul className="space-y-2">
              ...
              <li>• Pensar que ganar más dinero siempre significa ganar poder de compra.</li>
              <li>• Usar una inflación que no corresponde al plazo de la inversión.</li>
            </ul>
          </SeoSection>
