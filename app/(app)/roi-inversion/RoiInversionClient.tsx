    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="0"
          className={`w-full rounded-2xl border border-zinc-800 bg-zinc-950 py-3 text-zinc-100 outline-none transition placeholder:text-zinc-600 focus:border-zinc-500 ${leftPaddingClass} ${rightPaddingClass}`}
        />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-10 rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm leading-relaxed text-zinc-400">
            ...
            <li>• Si el ROI es positivo, la inversión generó ganancia.</li>
            <li>• Si el ROI es cero, la inversión quedó empatada.</li>
            <li>• Si el ROI es negativo, la inversión generó pérdida.</li>
            <li>
        ...
        <section className="mt-6 rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm leading-relaxed text-zinc-400">
            ...
            <li>• No mide volatilidad ni probabilidad de pérdida.</li>
            <li>• El resultado depende de que los datos ingresados sean correctos.</li>
            <li>• Es una herramienta de cálculo, no asesoramiento financiero.</li>
          </ul>
        </section>
