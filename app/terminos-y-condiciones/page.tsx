...
export const metadata: Metadata = {
  ...
  description: "Condiciones de uso y contratación de Calculadora Emprendedora, un servicio de Growtella.",
};
    ...
    >
      <div className="grid gap-5">
        ...
        <LegalSection number="6" title="Precios, moneda y renovación">
          <p>Los planes Pro se cobran por adelantado en dólares estadounidenses mediante PayPal. El precio, período y renovación automática se muestran antes de confirmar la suscripción. PayPal o el emisor del medio de pago pueden aplicar conversión, comisiones o impuestos fuera del control de Growtella.</p>
        ...
        <LegalSection number="11" title="Responsabilidad y legislación aplicable">
          <p>Ninguna disposición limita derechos irrenunciables del consumidor. Dentro de lo permitido por la ley, Growtella no responde por decisiones tomadas exclusivamente sobre resultados no verificados, pérdidas indirectas o fallas atribuibles a terceros.</p>
