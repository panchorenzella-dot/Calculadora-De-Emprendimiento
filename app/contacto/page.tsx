    ...
    <main className="min-h-screen bg-zinc-950 text-white">
      <section className="border-b border-white/10 bg-[radial-gradient(circle_at_top,rgba(52,211,153,0.12),transparent_45%)]">
        <div className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
          ...
          <a href="mailto:calculadoraemprendedora@gmail.com" className="mt-8 inline-flex rounded-xl bg-emerald-300 px-5 py-3 font-semibold !text-black transition hover:bg-emerald-200">Enviar un email →</a>
        </div>
      </section>
      <div className="mx-auto max-w-6xl px-6 py-14">
        ...
        <section className="mt-12 grid gap-6 rounded-3xl border border-emerald-300/15 bg-emerald-300/[0.04] p-7 md:grid-cols-[1fr_auto] md:items-center">
          ...
          <a href="mailto:calculadoraemprendedora@gmail.com?subject=Consulta%20desde%20Calculadora%20Emprendedora" className="rounded-xl border border-emerald-300/30 px-5 py-3 text-center text-sm font-semibold text-emerald-300 hover:bg-emerald-300/10">Escribir ahora</a>
        </section>
